(function () {
    ...
    var AUTO_TRANSLATIONS = {
        ...
        "hack the universe [YouTube Playlist]": { ar: "[canceled] اخترق الكون [قائمة يوتيوب]", fa: "[canceled] هک جهان [فهرست پخش یوتیوب]", zh: "[canceled] hack the universe [YouTube 播放列表]" },
    ...
    function pageEntries(page) {
        var map = {
            "index.html": [
                ...
                { type: "text", selector: ".links li:nth-child(10) a", value: { en: "[canceled] hack the universe [YouTube Playlist]", fr: "[canceled] pirater l'univers [Liste YouTube]", es: "[canceled] hackea el universo [Lista de YouTube]", ar: "[canceled] اختراق الكون [قائمة تشغيل يوتيوب]", fa: "[canceled] هک جهان [لیست پخش یوتیوب]", zh: "[canceled] 破解宇宙 [YouTube 播放列表]" } },
            ...
            "embedded.html": [
                ...
                { type: "text", selector: ".links li:nth-child(9) a", value: { en: "[canceled] hack the universe [YouTube Playlist]", fr: "[canceled] pirater l'univers [Liste YouTube]", es: "[canceled] hackea el universo [Lista de YouTube]", ar: "[canceled] اختراق الكون [قائمة تشغيل يوتيوب]", fa: "[canceled] هک جهان [لیست پخش یوتیوب]", zh: "[canceled] 破解宇宙 [YouTube 播放列表]" } },
