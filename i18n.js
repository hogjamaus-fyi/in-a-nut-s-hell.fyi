    ...
    function pageEntries(page) {
        var map = {
            "index.html": [
                ...
                { type: "text", selector: ".links li:nth-child(8) a", value: { en: "hack the universe [YouTube Playlist]", fr: "pirater l'univers [Liste YouTube]", es: "hackea el universo [Lista de YouTube]", ar: "اختراق الكون [قائمة تشغيل يوتيوب]", fa: "هک جهان [لیست پخش یوتیوب]", zh: "破解宇宙 [YouTube 播放列表]" } },
                { type: "text", selector: ".links li:nth-child(9) a", value: { en: "posts, toasts and roasts [Twitter]", fr: "posts, toasts et roasts [Twitter]", es: "posts, toasts y roasts [Twitter]", ar: "المشاركات والخبز المحمص والتحميص [تويتر]", fa: "پست ها، نان تست و کباب [توئیتر]", zh: "帖子、祝酒词和烤肉 [Twitter]" } },
            ...
            "embedded.html": [
                ...
                { type: "text", selector: ".links li:nth-child(8) a", value: { en: "posts, toasts and roasts [Twitter]", fr: "posts, toasts et rotis [Twitter]", es: "posts, toasts y roasts [Twitter]", ar: "المشاركات والخبز المحمص والتحميص [تويتر]", fa: "پست ها، نان تست و کباب [توئیتر]", zh: "帖子、祝酒词和烤肉 [Twitter]" } },
